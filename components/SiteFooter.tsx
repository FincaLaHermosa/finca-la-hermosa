...
export function SiteFooter({ config = defaultSiteConfig }: { config?: SiteConfig }) {
  ...
  return (
    <footer className="site-footer">
      <div className="footer-grid">
        ...
        <div className="footer-social-group">
          ...
          <div className="social-row">
            <a href={config.instagramUrl} className="social-circle" target="_blank" rel="noopener" aria-label="Instagram">
            ...
            <a href={config.facebookUrl} className="social-circle" target="_blank" rel="noopener" aria-label="Facebook">
            ...
            <a href={`https://wa.me/${config.whatsappNumber}`} className="social-circle" target="_blank" rel="noopener" aria-label="WhatsApp">
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="footer-contact-group">
          ...
          <span className="footer-contact-line">
            <a href={`tel:${config.phoneHref}`}>{config.phoneLabel}</a>
          </span>
          <span className="footer-contact-line">
      ...
      <div className="footer-bottom">
        <p className="footer-copy">{config.copyrightLabel}</p>
