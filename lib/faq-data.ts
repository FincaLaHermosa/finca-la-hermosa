...
export const faqCategories: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Tu fecha queda reservada con el pago del 50% del total. El resto se liquida 30 días antes del evento. Al confirmar recibirás contrato digital, recibo y el desglose de tu reservación.",
      },
      {
        id: "cancelar-mover",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Sí. Tenemos tarifas especiales para paquetes de fin de semana completo, de viernes noche a domingo. Es una opción muy popular para retiros familiares y equipos que quieren desconectarse. Pregunta por disponibilidad al solicitar tu propuesta.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "El precio base cubre 14 horas de uso exclusivo de la finca (8:00 a 22:00 h), staff de limpieza y mantenimiento durante el evento, estacionamiento para 40 vehículos y acceso completo a jardines, alberca, terraza, asador y áreas comunes. Solo recibimos un evento por día.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "No agregamos cargos sin avisarte. Tu propuesta muestra el desglose de espacios, extras y condiciones. Si durante la planeación sumas algo, te compartimos el costo antes de confirmarlo.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Sí, trabajamos con lista abierta de proveedores. Puedes traer tu propio catering, DJ, decorador, fotógrafo o cualquier otro proveedor. Solo pedimos registrarlos con anticipación para coordinar accesos. Si prefieres recomendaciones, tenemos alianzas con proveedores locales que conocen bien la finca.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "Completamente. Los paquetes son el punto de partida, no el límite. Puedes agregar o quitar add-ons según tus necesidades, y la propuesta se ajusta a lo que elegiste.",
      },
      {
        id: "catering",
        question: "¿Ofrecen servicio de catering o banquetes?",
        answer:
          "No gestionamos catering directamente, pero tenemos alianza con proveedores locales de cocina regional que conocen la logística de la finca. Si lo deseas, te los presentamos en tu propuesta. También puedes traer el proveedor de tu preferencia: la cocina equipada y el asador están disponibles para uso externo.",
      },
      {
        id: "tipo-eventos",
