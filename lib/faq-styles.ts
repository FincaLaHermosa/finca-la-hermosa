export const faqStyles = String.raw`
/* ── TOKENS ─────────────────────────────────────────────── */
@font-face {
  font-family: 'Against';
...
.nav-pill.scrolled {
  background: rgba(28,46,44,0.88); border-color: rgba(255,255,255,0.13);
...
.nav-links a {
  ...
  color: rgba(255,253,248,0.72); text-decoration: none;
...
/* ── OVERLINE ─────────────────────────────────────────────── */
.overline {
  font-family: 'Jost', sans-serif; font-size: 0.67rem; font-weight: 500;
...
/* ── ARCH LABEL ─────────────────────────────────────────── */
.arch-label {
  font-family: 'Against', serif; font-size: clamp(5rem,8vw,9rem);
...
/* ── CTA CARD ────────────────────────────────────────────── */
.cta-card {
  padding: 30px 26px; background: rgba(255,255,255,0.07);
...
/* ── Hero ───────────────────────────────────────────────── */
.hero-faq {
  min-height: 62vh; background: var(--verde-dark);
...
.faq-group-label {
  ...
  margin-bottom: 16px; padding-bottom: 10px; border-bottom: 1px solid var(--crema-border);
}

/* ── Accordion ──────────────────────────────────────────── */
.faq-item { border-bottom: 1px solid var(--crema-border); transition: border-color 0.22s; }
...
.faq-q-text {
  ...
  font-weight: 400; color: var(--verde-dark); line-height: 1.35;
  transition: color 0.22s;
}
.faq-item.open .faq-q-text { color: var(--verde); }
.faq-icon {
  width: 28px; height: 28px; border-radius: 50%;
  border: 1px solid var(--crema-border);
  display: flex; align-items: center; justify-content: center;
  flex-shrink: 0; transition: all 0.35s var(--ease-out); color: var(--muted);
}
