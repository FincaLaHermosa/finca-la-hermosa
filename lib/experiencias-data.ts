...
export const experienceAddons: ExperienceAddon[] = [
  {
    ...
    description: "Salón principal 22×14 m con cocineta equipada y mobiliario completo incluido.",
    price: "+ $8,000 MXN",
  },
  {
    id: "fogata",
    ...
    description: "Sesión de fogata con leña incluida, área preparada y encendido inicial.",
    price: "+ $700 MXN",
  },
  {
    id: "cine",
    ...
    description: "Pantalla exterior, proyector HD y sistema de audio. Instalación y operación incluidas.",
    price: "+ $700 MXN",
  },
  {
    id: "coffee",
    ...
    description: "Estación de café, té, agua y botanas para todo el día. Servicio montado y reabastecido.",
    price: "+ $700 MXN",
  },
  {
    id: "av",
    ...
    description: "Pantalla LED, micrófono inalámbrico y bocinas profesionales. Ideal para presentaciones.",
    price: "+ $700 MXN",
  },
  {
    id: "hospedaje",
    ...
    description: "Casa completa con 6 habitaciones para quienes quieran quedarse a dormir.",
